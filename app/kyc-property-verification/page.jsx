...
const ACCOUNT_TYPES = [
  {
    ...
    desc: 'Individual who owns residential or commercial property and wants to list or manage it',
    icon: <svg width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9,22 9,12 15,12 15,22"/></svg>,
  },
  {
    value: 'real_estate_agent',
    label: 'Real Estate Agent / Broker',
    desc: 'Licensed individual agent or broker representing buyers and sellers in property transactions',
  ...
  },
  {
    ...
    label: 'Real Estate Brokerage Company',
    desc: 'Registered company providing brokerage services for property sales, rentals and investments',
    icon: <svg width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16"/></svg>,
  },
  {
    value: 'property_developer',
    label: 'Property Developer / Builder',
    desc: 'Company or individual developing new residential or commercial real estate projects',
  ...
  },
  {
    ...
    desc: 'Company managing rental properties, maintenance and tenant relations on behalf of owners',
    icon: <svg width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>,
  },
  {
    value: 'poa_representative',
    label: 'POA / Representative',
    desc: 'Person acting under a Power of Attorney or as an authorised representative for a property owner',
