    ...
    sections: [
      {
        ...
        cols: 3,
        items: [
          { icon: "🇦🇪", label: "UAE",       sub: "Dubai · Abu Dhabi · Sharjah · Ajman",         href: "/listings?location=UAE" },
          { icon: "🇺🇸", label: "USA",       sub: "New York · Miami · Los Angeles · Texas",       href: "/listings?location=USA" },
          { icon: "🇵🇹", label: "Portugal",  sub: "Lisbon · Porto · Algarve · Madeira",           href: "/listings?location=Portugal" },
          { icon: "🇦🇺", label: "Australia", sub: "Sydney · Melbourne · Brisbane · Perth",        href: "/listings?location=Australia" },
        ],
      },
      {
        ...
        cols: 3,
        items: [
          { icon: "🇹🇷", label: "Turkey",  sub: "Istanbul · Antalya · Bodrum · Izmir",          href: "/listings?location=Turkey" },
          { icon: "🇨🇾", label: "Cyprus",  sub: "Limassol · Nicosia · Paphos · Larnaca",        href: "/listings?location=Cyprus" },
          { icon: "🇲🇹", label: "Malta",   sub: "Valletta · Sliema · St Julian's · Gozo",       href: "/listings?location=Malta" },
          { icon: "🇨🇦", label: "Canada",  sub: "Toronto · Vancouver · Calgary · Montreal",     href: "/listings?location=Canada" },
        ],
      },
      {
        ...
        cols: 3,
        items: [
          { icon: "🇭🇺", label: "Hungary",     sub: "Budapest · Debrecen · Pécs",                href: "/listings?location=Hungary" },
          { icon: "🇱🇻", label: "Latvia",      sub: "Riga · Jürmala · Daugavpils",               href: "/listings?location=Latvia" },
          { icon: "🇵🇭", label: "Philippines", sub: "Manila · Cebu · Davao · Boracay",           href: "/listings?location=Philippines" },
          { icon: "🇲🇾", label: "Malaysia",    sub: "Kuala Lumpur · Penang · Johor Bahru · Langkawi", href: "/listings?location=Malaysia" },
        ],
      },
    ],
  },
