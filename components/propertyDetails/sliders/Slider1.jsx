...
const FALLBACK = "/images/section/property-detail-3.jpg";

export default function Slider1({ images = [], title = "" }) {
  const imgs = images?.length ? images : [];
  const img1 = imgs[0] || FALLBACK;
  const img2 = imgs[1] || img1;
  const img3 = imgs[2] || img1;
  const img4 = imgs[3] || img2;
  const totalPhotos = imgs.length || 1;
            ...
            <div className="col-12">
              <div className="wrap-image">
                <div className="image img-1">
                  <Item original={img1} thumbnail={img1} width={1095} height={771}>
                    {({ ref, open }) => (
                      <a
                        onClick={open}
                ...
                <div className="wrap-image-right">
                  ...
                  <div className="bot">
                    <div className="image img-3">
                      <Item original={img3} thumbnail={img3} width={392} height={375}>
                        {({ ref, open }) => (
                          <a onClick={open} className="image-wrap relative d-block" style={{ cursor: "pointer", display: "block", height: "100%" }}>
                            <Image ref={ref} alt="" src={img3} width={392} height={375} style={{ objectFit: "cover", width: "100%", height: "100%" }} unoptimized />
                          </a>
                        )}
                      </Item>
                    </div>
                    <div className="image img-4">
                      <Item original={img4} thumbnail={img4} width={392} height={375}>
                        {({ ref, open }) => (
                          <a onClick={open} className="image-wrap relative d-block" style={{ cursor: "pointer", display: "block", height: "100%" }}>
                            <Image ref={ref} alt="" src={img4} width={392} height={375} style={{ objectFit: "cover", width: "100%", height: "100%" }} unoptimized />
                          </a>
                        )}
                      </Item>
                    </div>
