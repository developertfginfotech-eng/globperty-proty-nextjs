...
export default function Features() {
  return (
    <div className="wrap-section style-1">
      <div className="tf-container">
        {/* section-selling-home  */}
        <div className="section-selling-home style-3 tf-spacing-7">
          <div className="row">
            <div className="col-12">
              <div className="heading-section text-center mb-56">
                <h2 className="title text_white split-text effect-right">
                  <SplitTextAnimation text="Selling Your Home With Realty" />
                </h2>
                <p className="text-1 text-color3 split-text split-lines-transform">
              ...
              <div
                ...
                data-space={15}
              >
                <div className="swiper-wrapper tf-layout-mobile-sm lg-col-4 sm-col-2">
                  <div className="swiper-slide">
                    <div
                      className="icons-box style-4 v2 effec-icon wow animate__fadeInLeft animate__animated"
              ...
              >
                ...
                <div className="sw-pagination sw-pagination-mb-1 text-center d-md-none d-block mt-20 spd457" />
              </Swiper>
            </div>
          </div>
        </div>
        <div className="row">
          <div className="col-12">
            <div className="heading-section text-center mb-56">
              <h2 className="title text_white split-text effect-right">
                <SplitTextAnimation text="The Best Real Estate For You" />
              </h2>
              <p
                className="text-1 text-color3 split-text split-lines-transform"
            ...
            <div className="text-with-form style-2 relative mx-0">
              <div className="swiper sw-single">
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <Image
                      className="lazyload"
                      data-src="/images/section/banner-4.jpg"
                      alt=""
                      src="/images/section/banner-4.jpg"
                      width={1280}
                      height={703}
                    />
                  </div>
                  <div className="swiper-slide">
                    <Image
                      className="lazyload"
                      data-src="/images/section/banner-5.jpg"
                      alt=""
                      src="/images/section/banner-5.jpg"
                      width={1280}
                      height={703}
                    />
                  </div>
              ...
              <div className="content">
                <div>
                  ...
                  <div className="d-flex justify-content-between align-items-center gap-12 flex-wrap">
                    ...
                    <a
                      href="#"
                      className="tf-btn pd-26 style-border rounded-cycle"
                    >
                      Details
                ...
                <div>
                  ...
                  <a
                    href="#"
                    className="tf-btn w-full bg-color-secondary btn-main"
                  >
