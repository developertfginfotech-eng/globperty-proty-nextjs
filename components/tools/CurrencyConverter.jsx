      ...
      <div className="tf-container">
        <div className="box-calculate">
          ...
          <div style={{ background: "linear-gradient(90deg, #f0822d, #e56c1a)", padding: "20px 32px", display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              <div style={{ fontSize: 17, fontWeight: 700, color: "#fff" }}>Property Currency Converter</div>
              <div style={{ fontSize: 12, color: "rgba(255,255,255,0.8)", marginTop: 2 }}>Live exchange rates across 17 investment currencies</div>
            </div>
          </div>
