        ...
        <div className="row justify-center">
          <div className="col-lg-9">
            ...
            <div className="heading-section text-center mb-48">
              ...
              <p className="text-1">Estimate your monthly repayments and total cost of borrowing.</p>
            </div>
            ...
            <div style={{ background: "#fff", borderRadius: 20, boxShadow: "0 8px 40px rgba(0,0,0,0.08)", border: "1px solid rgba(240,130,45,0.15)", overflow: "hidden" }}>
              <div style={{ background: "linear-gradient(90deg, #f0822d, #e56c1a)", padding: "18px 32px", display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <span style={{ fontSize: 16, fontWeight: 700, color: "#fff" }}>Enter Mortgage Details</span>
              </div>

              <div style={{ padding: "32px" }}>
                <div className="row g-3 mb-20">
                  <div className="col-md-6">
                    <label className="text-1 fw-6" style={{ display: "block", marginBottom: 8, color: "#374151" }}>Property Price ($)</label>
                    <fieldset>
                  ...
                  <div className="col-md-6">
                    <label className="text-1 fw-6" style={{ display: "block", marginBottom: 8, color: "#374151" }}>Down Payment (%)</label>
                    <fieldset>
                  ...
                  <div className="col-md-6">
                    <label className="text-1 fw-6" style={{ display: "block", marginBottom: 8, color: "#374151" }}>Annual Interest Rate (%)</label>
                    <fieldset>
                  ...
                  <div className="col-md-6">
                    <label className="text-1 fw-6" style={{ display: "block", marginBottom: 8, color: "#374151" }}>Loan Term (years)</label>
                    <fieldset>
                ...
                <button onClick={calculate} className="tf-btn bg-color-primary w-full" style={{ height: 54, fontSize: 16, fontWeight: 700, borderRadius: 10 }}>
                ...
                {result && (
                  <div style={{ marginTop: 32 }}>
                    ...
                    <div style={{ background: "linear-gradient(135deg, #f0822d 0%, #e56c1a 100%)", borderRadius: 14, padding: "28px 32px", textAlign: "center", marginBottom: 20 }}>
                      ...
                      <div style={{ fontSize: 44, fontWeight: 900, color: "#fff", letterSpacing: -1 }}>
                        ${fmt(result.monthlyPayment)}
                      </div>
                      <div style={{ fontSize: 13, color: "rgba(255,255,255,0.75)", marginTop: 8 }}>
                        Over {result.loanYears} years
                      </div>
                    </div>
